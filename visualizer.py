...
# only do horizontal or vertical, one at a time
#test_images must corespond with weights, vert = vert etc

weights = 'horizontal.pt'
test_images = r"C:\Users\gohti\OneDrive\Desktop\Fyp_Rosbags\Adversarial_ducks\emptytrack_1_duckcutoff_awc1_horiz"
...
# test-images is folder to .npy file for duck cutoff
...
for f in ti:
    ...
    # your value that you compare with ground truth

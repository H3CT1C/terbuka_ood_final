...
#opening csv file to write the optical flows into
...
weights_h = 'C:\\terbuka_ood\\terbuka_ood\\horizontal.pt'
weights_v = 'C:\\terbuka_ood\\terbuka_ood\\vertical.pt'

# must be images
test_images = r"C:\Users\gohti\OneDrive\Desktop\Fyp_Rosbags\Adversarial_ducks\emptytrack_1_duckcutoff_awc1_images"
...
kl_cal_h = None
mse_cal_h = None
# with open(f'{weights_h.replace(".pt", "")}.json', 'r') as cal_f:
...
# kl_cal_v = None
# mse_cal_v = None
# with open(f'{weights_v.replace(".pt", "")}.json', 'r') as cal_f:
#     data = json.loads(cal_f.read())
...
df['test_results'] = pd.Series(flow_list)
df['test_results'].to_csv(r"C:\Users\gohti\OneDrive - Nanyang Technological University\FYP_ROS_OOD\emptytrack_1_duckcutoff_awc1 (1).csv")
writer.release()
